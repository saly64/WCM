...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NewsConnectionString %>" DeleteCommand="DELETE FROM articles WHERE id=@id" SelectCommand="SELECT * FROM [Articles]" UpdateCommand="UPDATE articles SET title=@title,details=@details WHEREid=@id"></asp:SqlDataSource>
            <br />
